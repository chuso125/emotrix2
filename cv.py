...
with open('best_params.csv','w') as write_csv:
    ...
    for file in os.listdir(os.getcwd()+"/Image-data (1)"):
        if file.endswith(".csv"):
            ...
            clf = GridSearchCV(ensemble.GradientBoostingRegressor(max_features='sqrt', learning_rate=0.2, n_estimators=70, min_samples_split=56, min_samples_leaf=50, max_depth=8, subsample=0.8), param_grid, cv=5, n_jobs=10)
